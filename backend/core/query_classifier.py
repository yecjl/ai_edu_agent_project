...
if __name__ == '__main__':
    ...
    # qc = QueryClassifier(model_path="/Users/yezhimeier/Study/Heima/bigdata/code/models/classifier/all-MiniLM-L6-v2")
    # qc.train(
    #     data_path="./data/training_data.jsonl",
    #     output_dir="/Users/yezhimeier/Study/Heima/bigdata/code/edu_agent_project/project/backend/models/classifier/query-classifier-finetuned",
    #     epochs=8,
    #     batch_size=64,
    # )
